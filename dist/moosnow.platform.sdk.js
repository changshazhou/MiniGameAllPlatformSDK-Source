                ...
                _this.loadArea(function (res2) {
                    _this.disableAd(res, res2, function (disable) {
                        ...
                        if (disable) {
                            ...
                            callback(__assign(__assign({}, res), { mistouchNum: 0, mistouchPosNum: 0, mistouchInterval: 0, exportBtnNavigate: 0, checkBoxMistouch: 0, exportAutoNavigate: exportAutoNavigate, bannerShowCountLimit: 1, isLimitArea: 1 }));
                        }
                        else {
                            if (res.exportAutoNavigate == 2)
                                exportAutoNavigate = 1;
